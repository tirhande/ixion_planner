...
const SVGContainer = () => {
  ...
  const constructBuilding = ({ x, y }: IPoint) => {
    if (isWall) {
      ...
      const posX = (stickY === 0 ? (wallX < borderPoint.minX ? borderPoint.minX : (wallX > borderPoint.maxX ? borderPoint.maxX : wallX)) : (diffX < borderPoint.minX ? borderPoint.minX : (diffX > borderPoint.maxX ? borderPoint.maxX : diffX)))
